...
namespace ServerAPI.Authentication
{
    public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// 4.1.4.  "exp" (Expiration Time) Claim - The "exp" (expiration time) claim identifies the expiration 
        ...
        /// </summary>
        public TimeSpan ValidFor { get; set; } = TimeSpan.FromMinutes(value: 120);
