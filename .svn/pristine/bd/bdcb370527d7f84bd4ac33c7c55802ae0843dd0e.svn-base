...
namespace ServerAPI.Controllers
{
    ...
    public class AppointmentController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertSchedule(InmateApptDetailsVm inmateApptDetails)
        {
		...
		public async Task<IActionResult> InsertIncidentSchedule(InmateApptDetailsVm inmateApptDetails)
		{
			return Ok(await _inmateIncidentAppointmentService.InsertSchedule(inmateApptDetails));			
		}

        [HttpPost("DeleteIncidentAppointment")]
        public async Task<IActionResult> DeleteIncidentAppointment(DeleteUndoInmateAppt deleteInmateAppt)
        {
        ...
        public async Task<IActionResult> InsertScheduleTransfer(InmateApptDetailsVm inmateApptDetails)
        {
            return Ok(await _appointmentService.InsertSchedule(inmateApptDetails));
        }

        [HttpPut("UpdateSchedule")]
        public async Task<IActionResult> UpdateSchedule(InmateApptDetailsVm inmateApptDetails)
        {
        ...
        public async Task<IActionResult> UpdateScheduleTransfer(InmateApptDetailsVm inmateApptDetails)
        {
            return Ok(await _appointmentService.UpdateSchedule(inmateApptDetails));
        }
            ...
            string housingUnitLocation, string housingUnitNumber, int? inmateId, string fromModule)
        {
            return Ok(_appointmentService.GetBumpQueueInfo(facilityId, isActiveBump, startDate, endDate,
                housingUnitLocation, housingUnitNumber, inmateId, fromModule));
        }

        [HttpPost("ClearBumpQueue")]
        public async Task<IActionResult> ClearBumpQueue(KeyValuePair<int, string> clearBumpQueue)
        {
        ...
        public async Task<IActionResult> InsertMultiInmateAppt(InmateApptDetailsVm inmateApptDetails, 
            [FromQuery]List<int> inmateIds)
        {
        ...
        public async Task<IActionResult> DeleteInmateAppointment(DeleteUndoInmateAppt deleteInmateAppt)
        {
            return Ok(await _appointmentService.DeleteInmateAppointment(deleteInmateAppt));
        }

        [HttpPost("UndoInmateAppointment")]
        public async Task<IActionResult> UndoInmateAppointment(DeleteUndoInmateAppt undoInmateAppt)
        {
            return Ok(await _appointmentService.UndoInmateAppointment(undoInmateAppt));
        }

        [HttpPost("CreateAppointment")]
        public IActionResult CreateAppointment(CreateAppointmentRequest appointmentRequest)
        {
        ...
        public IActionResult GetInmateDetails(List<int> inmateIds)
        {
