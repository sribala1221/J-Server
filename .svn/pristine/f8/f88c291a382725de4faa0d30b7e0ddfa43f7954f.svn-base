...
namespace ServerAPI.Controllers
{
    ...
    public class SentenceController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteArrestBookingStatus(BookingStatusVm value)
        {
        ...
        public async Task<IActionResult> UpdateArrestBookingStatus(BookingStatusVm value)
        {
            return Ok(await _sentenceService.UpdateArrestBookingStatus(value));
        }
        ...
        public async Task<IActionResult> InsertArrestSentFlag(List<SentenceAdditionalFlagsVm> additionalFlagsList)
        {
            return Ok(await _sentenceService.InsertArrestSentFlag(additionalFlagsList));
        }

        [HttpPost("DeleteArrestSentFlag")]
        public async Task<IActionResult> DeleteArrestSentFlag( int arrestSentFlagId)
        {
        ...
        public async Task<IActionResult> ClearArrestSentence(int arrestId)
        {
            return Ok(await _sentenceService.ClearArrestSentence(arrestId));
        }

        [HttpPost("ClearCrimeSentence")]
        public async Task<IActionResult> ClearCrimeSentence(int crimeId)
        {
        ...
        public async Task<IActionResult> UpdateUnSentArrestSentence(SentenceDetailsVm obj)
        {
        ...
        public async Task<IActionResult> UpdateSentArrestSentence(SentenceDetailsVm obj)
        {
            return Ok(await _sentenceService.UpdateArrestSentence(obj));
        }
        ...
        public async Task<IActionResult> UpdateHoldArrestSentence(SentenceDetailsVm obj)
        {
            return Ok(await _sentenceService.UpdateArrestSentence(obj));
        }
        ...
        public async Task<IActionResult> UpdateAltSentArrestSentence(SentenceDetailsVm obj)
        {
            return Ok(await _sentenceService.UpdateArrestSentence(obj));
        }

        [HttpPost("UpdateArrestSentence")]
        public async Task<IActionResult> UpdateArrestSentence(SentenceDetailsVm obj)
        {
            return Ok(await _sentenceService.UpdateArrestSentence(obj));
        }
        ...
        public async Task<IActionResult> UpdateArrestSentenceGap(List<SentenceDetailsVm> obj)
        {
            return Ok(await _sentenceService.UpdateArrestSentenceGap(obj));
        }

        [HttpPost("UpdateCrimeSentenceGap")]
        public async Task<IActionResult> UpdateCrimeSentenceGap(List<ChargeSentenceVm> obj)
        {
            return Ok(await _sentenceService.UpdateCrimeSentenceGap(obj));
        }

        [HttpPost("UpdateChargeSentence")]
        public async Task<IActionResult> UpdateChargeSentence(SentenceDetailsVm obj)
        {
            return Ok(await _sentenceService.UpdateChargeSentence(obj));
        }

        [HttpPost("UpdateChargeSentenceList")] //[FromBody] SentenceDetailsVm obj, List<int> crimeIds)
        public async Task<IActionResult> UpdateChargeSentenceList(ChargeReplicateSentenceDetails obj)
        {
            return Ok(await _sentenceService.UpdateChargeSentenceList(obj.SentenceDetails, obj.CrimeIds));
        }
        ...
        public async Task<IActionResult> UpdateOverallSentence(OverallSentenceVm obj)
        {
        ...
        public async Task<IActionResult> UpdateManualOverallSentence(OverallSentenceVm obj)
        {
            return Ok(await _sentenceService.UpdateOverallSentence(obj));
        }
