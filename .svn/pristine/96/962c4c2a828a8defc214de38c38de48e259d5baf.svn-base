...
namespace ServerAPI.ViewModels
{
    public class MoneyAccountTransactionVm
    {
        ...
        public int TransactionReturnCheckFlag { get; set; }
        ...
        public bool FundInmateOnlyFlag { get; internal set; }
        public int TransactionOfficerId { get; set; }
        public bool TransactionCashFlag { get; set; }
    ...
    public class MoneyAccountTransactionDetailVm
    {
        ...
        public List<MoneyAccountTransactionVm> unclearedDetails { get; set; }
        public List<MoneyAccountTransactionVm> InmateFeeDetails { get; set; }
        ...
        public decimal? UnClearedBalanceAmount { get; set; }
        public decimal? HistoryBalanceAmount { get; set; }
    }
