...
namespace ServerAPI.Services {
    public class MoneyCashService : IMoneyCashService {
        ...
        public MoneyAccountTransactionVm GetTransactionDetail (int transId,bool voidFlag) {
            MoneyAccountTransactionVm moneyAccountDetail = _context.AccountAoTransaction
                .Where (s =>( !voidFlag || (s.TransactionVoidTransactionId == transId && s.TransactionVoidFlag == 1)) &&
                    (voidFlag || (s.AccountAoTransactionFromId == transId || s.AccountAoTransactionToId == transId)))
