...
namespace ServerAPI.Controllers{
    ...
    public class AtimsReportsController : ControllerBase{
        ...
        public IActionResult GetReportStaticData(AtimsReportsCommonStaticDataRequest data)
        {
        ...
        [AllowAnonymous]
        public IActionResult GetReportParametersData(AtimsReportsParametersRequest data)
        {
        ...
        public async Task<IActionResult> GetReportData( AtimsReportsGetData data)
        {
