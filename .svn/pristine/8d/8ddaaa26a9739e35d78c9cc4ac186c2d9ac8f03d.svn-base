...
namespace ServerAPI.ViewModels
{
    public class VisitDetails
    {
        ...
        public List<VisitToAdultDetail> VisitToAdultDetails{get;set;}       
        public List<VisitorIdentityAndRelationship> VisitorIdentity { get; set; }
        ...
        public int? ProfVisitorType { get; set; }
        public string ProfessionalRelation { get; set; }
        public int HousingCount { get; set; }
        public PersonVm VisitorDetails{get;set;}
    }
    ...
    public class VisitSchedule
    {
        ...
        public bool isBumpQueue {get;set;}
    }
    public enum Gender
    {
        Male = 1,
